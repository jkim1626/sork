...
search_container = 'html.Div(className="row mx-0", style={"maxWidth": "98%", "margin": "0 auto", "padding": "0 20px"}, children=['
replace_container = 'html.Div(className="d-flex w-100", id="join-split-container", style={"height": "85vh", "flexDirection": "row", "maxWidth": "98%", "margin": "0 auto", "padding": "0 20px"}, children=['
code = code.replace(search_container, replace_container)

# 3. Update Left Column
search_left = 'html.Div(className="col-md-3", style={"height": "85vh", "overflowY": "auto", "paddingRight": "20px", "borderRight": "2px solid #eee"}, children=['
